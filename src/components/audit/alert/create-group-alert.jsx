...
const CreateGroupAlert = React.createClass({
    getInitialState() {
        return {
            status: true
        }
                ...
                <div className="box">
                    ...
                    <div className='flex-center'>
                        <div>
                            ...
                            <a className="button is-info" style={{ width: '120px', marginRight: '20px' }} onClick={this.alertOk}>确认</a>
                        </div>
                    </div>
...
export default CreateGroupAlert
